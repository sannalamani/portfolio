    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-blue-200 p-6 rounded-lg shadow-md">
          ...
          <p className="text-sm">
            Assisted in developing and maintaining front-end web applications using React.js and Redux to create dynamic and responsive user interfaces
            <br />Debugged and resolved UI bugs and issues by inspecting browser developer tools, ensuring optimal functionality and user experience across different browsers and devices
